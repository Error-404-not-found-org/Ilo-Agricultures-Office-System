  ...
  const getNextAction = () => {
        ...
        return {
          ...
          actionButton: (
            <TouchableOpacity
              ...
              className="mt-3 py-2 items-center border rounded-xl"
              style={{
                borderColor: "#a855f7",
              }}
            >
    ...
    if (animal.reproductiveStatus?.toLowerCase() === "inseminated") {
      ...
      return {
        ...
        detail:
          diffDays >= 60
            ? "It's been 60+ days post-AI. Request a technician to perform a pregnancy check."
            : diffDays >= 18 && diffDays <= 24
              ? "Day 18-24 window. Observe closely for signs of heat/reheat."
              : `Day ${diffDays} post-AI. Maintain proper feeding and monitoring.`,
        badge:
          diffDays >= 60
            ? "Overdue"
            : diffDays >= 18 && diffDays <= 24
          ...
          <View className="mt-3 flex-col gap-2">
            <View className="flex-row gap-2">
              <TouchableOpacity
                ...
                style={{
                  ...
                  borderColor: isDark ? "rgba(249, 115, 22, 0.25)" : "#ffedd5",
                }}
              >
                <Text
                  style={{ fontFamily: "Outfit_800ExtraBold" }}
                  className="text-orange-600 dark:text-orange-400 text-[9px] uppercase tracking-wider"
                >
                  Report Heat
                </Text>
              </TouchableOpacity>
            ...
            {diffDays >= 60 && (
              ...
              >
                <Text
                  style={{ fontFamily: "Outfit_900Black" }}
                  className="text-white text-[9px] uppercase tracking-widest"
                >
    ...
    if (animal.reproductiveStatus === "In Heat") {
      return {
        ...
        detail:
          "Animal is currently in heat. Schedule or request an Artificial Insemination (AI).",
        badge: "Action Needed",
        color: "#10b981",
        ...
        actionButton: (
          <TouchableOpacity
            ...
            className="mt-3 py-2.5 items-center rounded-xl"
    ...
    if (animal.lastCalvingDate) {
      const recoveryDays = differenceInCalendarDays(
        new Date(),
        new Date(animal.lastCalvingDate),
      );
      if (recoveryDays < 45) {
        return {
          type: "recovery",
          title: "Postpartum Lockout",
          detail: `Day ${recoveryDays} of 45-day recovery. Reproductive actions are locked.`,
          badge: "Locked",
          color: "#6b7280",
          bg: isDark ? "rgba(107, 114, 128, 0.12)" : "#f3f4f6",
          border: isDark ? "rgba(107, 114, 128, 0.25)" : "#e5e7eb",
          ...
          >
            ...
            {nextAction && (
              <View className="mb-6">
                ...
                <View
                  className="p-4 rounded-3xl border flex-col"
                  style={{
