 ...
 *
 * @param fullComment Raw comment or note value
 * @returns Clean farmer note or empty string
 */
export function extractFarmerNote(fullComment: unknown): string {
...
const HEAT_SIGN_LABELS: Record<string, string> = {
 ...
 *
 * @param sign Raw heat sign string/identifier
 * @returns Human-readable label
 */
export function formatHeatSignLabel(sign: string): string {
  if (!sign) return "";
