...
export default function AddAIRecord() {
    ...
    },
    {
      ...
      onError: (error: any) => {
        if (error.message !== "OFFLINE_SAVED") {
          toast.error(
            error.response?.data?.message || "Error registering the animal.",
      ...
      try {
        ...
        toast.error(
          error.response?.data?.message ||
            "Failed to load farmer list. Check your connection.",
        );
      }
    };
    fetchFarmers();
  ...
  const handleNativeDateChange = (event: any, selectedDate: any) => {
    ...
    if (selectedDate) {
      setFormData({
        ...formData,
        [activeField]: selectedDate.toLocaleDateString(),
      });
    }
  };
  ...
  const handleSave = async () => {
    ...
    if (!formData.species || !formData.breed)
      return toast.error("Please specify a species and breed.");
          ...
          {[1, 2, 3, 4].map((s) => (
            <View
              ...
              style={{
                ...
                height: 4,
                borderRadius: 2,
                backgroundColor: s <= currentStep ? PRIMARY : "#f1f5f9",
              }}
            />
          ))}
        </View>
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                <View style={{ flex: 1 }}>
                  <InputField
                    ...
                    onChangeText={(t: string) =>
                      setFormData({ ...formData, ageYears: t })
                    }
                    placeholder="e.g. 2"
                ...
                <View style={{ flex: 1 }}>
                  <InputField
                    ...
                    onChangeText={(t: string) =>
                      setFormData({ ...formData, ageMonths: t })
                    }
                    placeholder="e.g. 6"
                    keyboardType="numeric"
                  />
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                <View style={{ flex: 1 }}>
                  <InputField
                    ...
                    onChangeText={(t: string) =>
                      setFormData({ ...formData, animalId: t })
                    }
                    placeholder="ID-001"
                  />
                </View>
          ...
          {currentStep === 2 && (
            <View>
              <DateSelector
                ...
                onSetNotYet={() =>
                  setFormData({ ...formData, aiDate: "Not Yet" })
                }
              />
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                <View style={{ flex: 1 }}>
                  <SelectField
                    ...
                    placeholder="Attempt"
                    onPress={() =>
                      openModal("noOfAI", "AI Attempt", AI_ATTEMPTS)
                    }
                  />
                </View>
                <View style={{ flex: 2 }}>
                  <SelectField
                    label="Estrus Type"
                    value={formData.estrusType}
                    placeholder="Select Type"
                    onPress={() =>
                      openModal("estrusType", "Estrus Type", ESTRUS_OPTIONS)
                    }
                  />
                </View>
              </View>
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                <View style={{ flex: 1 }}>
                  <InputField
                    ...
                    onChangeText={(t: string) =>
                      setFormData({ ...formData, sireBreed: t })
                    }
                    placeholder="e.g. PC Cross"
                  />
                </View>
                <View style={{ flex: 1 }}>
                  <InputField
                    ...
                    onChangeText={(t: string) =>
                      setFormData({ ...formData, sireCode: t })
                    }
                    placeholder="Code"
                  />
                </View>
          ...
          {currentStep === 3 && (
            <View>
              <DateSelector
                ...
                onSetNotYet={() =>
                  setFormData({ ...formData, pdDate: "Not Yet" })
                }
              />
              <SelectField
                label="Diagnosis Result"
                value={formData.pdResult}
                placeholder="Select Result"
                onPress={() => openModal("pdResult", "PD Result", PD_RESULTS)}
              />
              ...
              >
                ...
                >
                  PD is typically performed 60-90 days after insemination for
                  accurate results.
                </Text>
              </View>
            </View>
          ...
          {currentStep === 4 && (
            <View>
              <DateSelector
                ...
                onSetNotYet={() =>
                  setFormData({ ...formData, calfDate: "Not Yet" })
                }
              />
              ...
              <View style={{ flexDirection: "row", gap: 16 }}>
                ...
                <View style={{ flex: 1 }}>
                  <SelectField
                    ...
                    placeholder="Select"
                    onPress={() => openModal("calfSex", "Calf Sex", CALF_SEX)}
                  />
                </View>
              </View>
              ...
              <SelectField
                ...
                onPress={() =>
                  openModal("calvingEase", "Calving Ease", CALVING_EASE)
                }
              />
            </View>
          )}
