...
const AnimalCard = ({ item, onPress }: { item: Animal, onPress?: () => void }) => (
  <TouchableOpacity activeOpacity={0.8} onPress={onPress} className="bg-white rounded-2xl p-4 mb-3 border border-gray-100 flex-row gap-3" style={{ elevation: 2 }}>
    ...
    <View className="flex-1 justify-center">
      ...
      <Text className="text-xs text-gray-500 mb-1">{item.species} — {item.breed}</Text>
