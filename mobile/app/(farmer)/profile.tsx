      ...
      <ScrollView className="flex-1 bg-gray-50" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-6 pt-6 pb-8 bg-white rounded-b-[32px] shadow-sm mb-6">
            ...
            <View className="flex-row items-center gap-4">
                ...
                <View>
                    <Text className="text-xl font-bold text-gray-900">{user?.fullName || 'Farmer'}</Text>
                    ...
                    <View className="bg-blue-100 px-2 py-0.5 rounded-md self-start mt-1">
                        <Text className="text-blue-700 text-xs font-semibold">Farmer Account</Text>
                    </View>
                </View>
            </View>
        </View>
        ...
        <View className="px-6 mb-8">
            ...
            <View className="bg-white rounded-2xl overflow-hidden shadow-sm">
                ...
                <MenuItem 
                    ...
                    label="My Animals" 
                    onPress={() => console.log('My Animals')} 
                />
                 <View className="h-[1px] bg-gray-100 ml-14" />
                <MenuItem 
