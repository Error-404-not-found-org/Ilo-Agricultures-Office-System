...
import { Users, Activity, Syringe, Search, UserPlus } from 'lucide-react-native';
    ...
    <View className="flex-1 bg-[#F0F4FF]">
      ...
      >
        ...
        <View className="px-6 -mt-16 z-10 w-full mb-8">
          <View className="bg-white rounded-[32px] p-6 shadow-sm border border-gray-100">
            <View className="flex-row justify-between items-center mb-6">
              <Text className="text-slate-800 font-bold text-base">System Overview</Text>
        ...
        <View className="px-6 mb-8">
          <Text className="text-slate-800 font-bold text-[17px] mb-4">Quick Actions</Text>
...
const StatBox = ({ label, value, color }: { label: string; value: any; color: string }) => (
  <View className="w-1/3 items-center mb-2">
    ...
    <Text className="text-slate-400 text-[11px] uppercase tracking-widest font-bold mt-0.5">{label}</Text>
  </View>
);
