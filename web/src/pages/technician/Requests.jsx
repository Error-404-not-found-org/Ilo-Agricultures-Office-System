                                ...
                                <dl className="grid gap-2.5 text-xs">
                                  <div className="grid grid-cols-[4.5rem_minmax(0,1fr)] gap-2">
                                    ...
                                    <dd className="flex min-w-0 items-start gap-1.5 font-medium text-base-content/85">
                                      ...
                                      <span className="wrap-break-word">{req.workflowType === "AI" ? req.date : `${req.formattedDateOnly}, ${req.formattedTimeOnly}`}</span>
                                    </dd>
                                  </div>
                                  <div className="grid grid-cols-[4.5rem_minmax(0,1fr)] gap-2">
                                    ...
                                    <dd className="flex min-w-0 items-start gap-1.5 font-medium text-base-content/85">
                                      ...
                                      <span className="wrap-break-word">{req.location}</span>
                                    </dd>
                                  </div>
                                </dl>
                              </td>
