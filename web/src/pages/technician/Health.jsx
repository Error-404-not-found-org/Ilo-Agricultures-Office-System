      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6 mb-10 pt-6">
        <div>
          ...
          <p className="text-base-content/40 font-black uppercase tracking-widest text-[10px] flex items-center gap-2">
            ...
            Field Command: Manage veterinary deployments and sector treatments.
          </p>
        </div>
                    ...
                    <td colSpan="6" className="py-32 text-center">
                      ...
                      {selectedCalendarDate && (
                        <button
                          ...
                          className="mt-4 text-emerald-500 font-black text-[10px] uppercase tracking-widest hover:underline"
                        >
                          Clear Date Filter
                        </button>
                      )}
                      ...
                      <td className="px-6 py-7">
                        <div className="flex items-center gap-3">
                          {task.animal?.imageUrl ? (
                            ...
                            <div className="w-9 h-9 rounded-xl bg-base-200 items-center justify-center flex text-base-content/20 border border-base-300">
                              <Plus size={16} />
                            </div>
                          )}
                          <div>
              ...
              <div className="flex items-center gap-4 mb-10">
                ...
                <div>
                  ...
                  <p className="text-[10px] font-black uppercase text-base-content/30 tracking-widest">
                    Register Walk-in Health Service
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 bg-base-200 border-none rounded-2xl p-6 font-black text-sm focus:ring-2 focus:ring-emerald-500 transition-all resize-none text-base-content placeholder:text-base-content/20"
                  ></textarea>
                </div>
                <button
                  onClick={() => {
                    toast.success("Walk-in record logged!");
