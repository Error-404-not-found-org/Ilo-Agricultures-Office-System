                  ...
                  paginatedLogs.map((l) => (
                    ...
                    >
                      ...
                      >
                        <button
                          onClick={() => setSelectedLog(l)}
                          className="px-2.5 py-1 text-[11px] font-bold rounded-lg border border-slate-200 dark:border-slate-800 hover:border-[#00643b] hover:text-[#00643b] flex items-center gap-1 bg-white dark:bg-slate-900 text-slate-600 dark:text-slate-400 transition-all cursor-pointer"
                        >
                          <Eye size={12} /> View
                        </button>
                      </td>
