        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 space-y-6">
            <form
              ...
              className="card bg-base-100 border border-base-300 rounded-2xl p-5  space-y-5"
            >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
                <div className="space-y-1">
                  <label htmlFor="pregnancy-window-days" className="text-[9px] font-black text-base-content/50 uppercase tracking-widest pl-1">
                    Pregnancy Diagnosis Window (Days Post-AI)
                  </label>
                  <input
                    id="pregnancy-window-days"
                    type="number"
                    value={pregWindow}
                    onChange={(e) => setPregWindow(e.target.value)}
                    className="w-full bg-base-200 border border-base-300 rounded-xl px-4 py-2.5 outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary font-bold"
                    min="30"
                    max="120"
                    required
                  />
                ...
                <div className="space-y-1">
                  <label htmlFor="max-insemination-retries" className="text-[9px] font-black text-base-content/50 uppercase tracking-widest pl-1">
                    Max Insemination Retries per Lifecycle
                  </label>
                  <input
                    id="max-insemination-retries"
                    type="number"
                    value={maxAttempts}
              ...
              <div className="space-y-3.5 pt-3 border-t border-base-300">
                <h4 className="text-[9px] font-black text-base-content/50 uppercase tracking-widest pl-1 flex items-center gap-1">
                  <Bell size={10} /> Notification & Alert Dispatch
                </h4>
                
                <div className="flex items-center justify-between p-3 bg-base-200 rounded-xl border border-base-300/80">
                  <div>
                    <p className="text-xs font-bold text-base-content">Email System Alerts</p>
                    <p className="text-[10px] text-base-content/50 font-semibold mt-0.5">Send monthly accomplishment files directly to provincial offices.</p>
                  </div>
                  <input
                    type="checkbox"
                    className="toggle toggle-primary"
                    aria-label="Enable email system alerts"
                    checked={emailAlerts}
                ...
                <div className="flex items-center justify-between p-3 bg-base-200 rounded-xl border border-base-300/80">
                  <div>
                    <p className="text-xs font-bold text-base-content">SMS Technician Broadcasts</p>
                    <p className="text-[10px] text-base-content/50 font-semibold mt-0.5">Send real-time alerts to officers when new clinical dispatches are created.</p>
                  </div>
                  <input
                    type="checkbox"
                    className="toggle toggle-primary"
                    aria-label="Enable SMS technician broadcasts"
                    checked={smsToggles}
            ...
            <div className="card bg-base-100 border border-base-300 rounded-2xl p-5  space-y-4">
              <h3 className="text-xs font-black text-base-content/50 uppercase tracking-widest flex items-center gap-1.5 pb-3 border-b border-base-300">
              ...
              <div className="flex flex-wrap gap-2">
                {breeds.map((breed, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-1.5 px-3 py-1 bg-base-200 border border-base-300 rounded-xl text-xs font-bold"
                  >
                    <span>{breed}</span>
                    <button
                      type="button"
              ...
              <form onSubmit={handleAddBreed} className="flex gap-2 text-xs pt-3 border-t border-base-300">
                <input
                  aria-label="New registered breed"
                  type="text"
                  placeholder="e.g. Red Sindhi"
                  value={newBreed}
                  onChange={(e) => setNewBreed(e.target.value)}
                  className="flex-1 bg-base-200 border border-base-300 rounded-xl px-4 outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary font-bold"
                  required
                />
                <button
                  type="submit"
          ...
          <div className="space-y-6">
            <div className="card bg-base-100 border border-base-300 rounded-2xl p-5  space-y-4">
              ...
              <p className="text-[11px] text-base-content/50 font-bold uppercase tracking-wider leading-relaxed">
              ...
              <div className="space-y-2 pt-2">
                ...
                <button
                  ...
                  className="w-full btn btn-sm btn-outline border-base-300 text-xs font-bold gap-1.5 rounded-xl text-base-content/60 hover:bg-base-200 transition-colors cursor-pointer"
                >
            ...
            <div role="alert" className="alert alert-error alert-soft items-start">
              ...
              <div>
                <h4 className="text-[10px] font-black text-error uppercase tracking-widest leading-none">
                  Critical Area
                </h4>
                <p className="text-[9px] font-bold text-base-content/50 uppercase mt-2 leading-relaxed tracking-wider">
