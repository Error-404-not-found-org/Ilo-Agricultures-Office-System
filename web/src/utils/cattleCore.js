...
export function generatePregnancyTimeline(inseminationDate, species, calfSex) {
  ...
  kindOfAddDays(ultrasoundCheckDate, 35); // Optimal 30-45 day scan bracket
  
  const palpationCheckDate = new Date(start.getTime());
  kindOfAddDays(palpationCheckDate, 60); // Manual examination threshold
...
function kindOfAddDays(date, days) {
