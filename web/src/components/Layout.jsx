    ...
    <div className="drawer lg:drawer-open font-['Outfit'] bg-base-200">
      ...
      <div className="drawer-side z-20">
        ...
        <div className="menu p-6 w-80 min-h-full bg-base-100 text-base-content flex flex-col border-r border-base-300 shadow-2xl">
          {/* Sidebar Header */}
          <div
            className="mb-8 px-2 flex items-center gap-3 group cursor-pointer"
            onClick={() =>
          ...
          <div className="flex flex-col gap-1.5 flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  <span
                    className={`transition-transform duration-300 ${isActive ? "scale-110" : "group-hover:scale-110 group-hover:text-emerald-500"}`}
                  >
            ...
            {role === "technician" && (
              <>
                ...
                <button
                  onClick={() =>
                    document.getElementById("moowie-trigger")?.click()
                  }
