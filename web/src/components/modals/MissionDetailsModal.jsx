            ...
            <div className="p-5">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div className="rounded-none border border-base-200 bg-base-200/20 p-4">
                  <h4 className="mb-3 text-[9px] font-black uppercase tracking-[0.25em] text-emerald-600/70 border-b border-emerald-500/10 pb-2">
                    Biological Metrics
                  </h4>
              ...
              <div className="mt-4 space-y-3">
                {pregnancy && (
                  <div className="flex gap-3 rounded-none border border-emerald-500/20 bg-emerald-500/3 p-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-[10px] leading-relaxed text-base-content/50">
                        Result: <span className="font-black text-emerald-600">{pregnancy.result || pregnancy.pregnancyDiagnosis?.result || pregnancy.status}</span> on {formatDate(pregnancy.date || pregnancy.pregnancyDiagnosis?.date)}.
                      </p>
                    </div>
                  </div>
                )}
                ...
                {calving && (
                  <div className="flex gap-3 rounded-none border border-emerald-500/20 bg-emerald-500/3 p-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-0.5 text-[10px] leading-relaxed text-base-content/50">
                        Date: <span className="font-black text-emerald-600">{formatDate(calving.date)}</span>
                      </p>
                      <div className="mt-2 flex flex-wrap gap-2">
                        <span className="inline-flex items-center rounded-none bg-emerald-500/10 px-2 py-0.5 text-[9px] font-black uppercase tracking-widest text-emerald-600">
                          {calving.numberOfCalves || (calving.calves?.length > 0 ? calving.calves.length : 1)} Calf Born
                        </span>
                        <span className="inline-flex items-center rounded-none bg-base-200/50 px-2 py-0.5 text-[9px] font-black uppercase tracking-widest text-base-content/60">
