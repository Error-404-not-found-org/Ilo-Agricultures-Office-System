    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-100 flex items-center justify-center p-4 bg-black/60 backdrop-blur-md">
        ...
        >
          ...
          <div className="overflow-y-auto flex-1 p-6 space-y-6 custom-scrollbar bg-base-100">
            ...
            <div className="flex items-center gap-4 bg-base-200/30 p-5 rounded-2xl border border-base-300/80">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <h2 className="text-lg font-black tracking-tighter text-base-content truncate uppercase leading-none">
                    Tag #{animal.earTag || "---"}
                  </h2>
                  <span className="px-2 py-0.5 text-[8px] font-black uppercase tracking-widest border border-emerald-500/20 bg-emerald-500/10 text-emerald-600 rounded-md">
            ...
            {animal.reproductiveStatus && animal.reproductiveStatus !== "Normal" && (
              <div className="flex gap-3 rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-5">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-0.5 text-[10px] leading-relaxed text-base-content/50 uppercase font-black tracking-wider">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h4 className="text-[10px] font-black uppercase tracking-[0.25em] text-base-content/40">Chronological Ledger</h4>
              </div>
              ...
              {loading ? (
                ...
                <div className="space-y-4">
                  {timeline.map((event) => (
                    <div 
                      key={event._id}
                      className="rounded-2xl border border-base-300 bg-base-200/20 overflow-hidden"
                    >
                      <button 
                        onClick={() => setExpandedId(expandedId === event._id ? null : event._id)}
                        className="w-full flex items-center justify-between p-4 text-left hover:bg-base-200/50 transition-all cursor-pointer"
                      >
                        <div className="flex items-center gap-4">
                           <div className={`w-8 h-8 rounded-lg flex items-center justify-center text-white shadow-sm ${
                             event.status?.toLowerCase() === "done" ? "bg-emerald-500" : "bg-base-300 text-base-content/40"
                           }`}>
                        ...
                        {expandedId === event._id && (
                          ...
                          >
                            <div className="p-4 border-t border-base-300 space-y-4">
                               <div>
                                  <p className="text-xs font-semibold leading-relaxed text-base-content/60 italic">
                                    "{event.description}"
                                  </p>
                               </div>
                               ...
                               <div className="pt-3 border-t border-base-200/50 flex items-center justify-between">
                ...
                <div className="flex flex-col items-center justify-center py-16 border border-dashed border-base-300 rounded-2xl">
          ...
          <div className="border-t border-base-300 bg-base-200/20 px-6 py-4 flex justify-end">
            <button
              onClick={onClose}
              className="px-6 py-2.5 bg-[#074033] hover:bg-[#0d5948] text-white text-[10px] font-black uppercase tracking-widest transition-colors rounded-xl shadow-md cursor-pointer"
            >
              Dismiss Details
            </button>
          </div>
